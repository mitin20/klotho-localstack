...
export { admissionregistration, apiextensions, apiregistration, apps, auditregistration, autoscaling, batch, certificates, coordination, core, discovery, events, extensions, flowcontrol, helm, kustomize, meta, networking, node, policy, rbac, resource, scheduling, settings, storage, types, yaml, };
