...
exports.createManagedNodeGroup = exports.ManagedNodeGroup = exports.computeWorkerSubnets = exports.createNodeGroupV2 = exports.createNodeGroup = exports.NodeGroupV2 = exports.NodeGroup = void 0;
...
`;
    ...
    const nodeLaunchTemplate = new aws.ec2.LaunchTemplate(`${name}-launchTemplate`, {
        imageId: amiId,
        instanceType: args.instanceType || "t2.medium",
        iamInstanceProfile: { arn: ((_d = args.instanceProfile) === null || _d === void 0 ? void 0 : _d.arn) || ((_e = core.nodeGroupOptions.instanceProfile) === null || _e === void 0 ? void 0 : _e.arn) },
        keyName: keyName,
        instanceMarketOptions: marketOptions,
        blockDeviceMappings: [{
                deviceName: device,
                ebs: {
                    encrypted: ((_f = args.nodeRootVolumeEncrypted) !== null && _f !== void 0 ? _f : false) ? "true" : "false",
                    volumeSize: (_g = args.nodeRootVolumeSize) !== null && _g !== void 0 ? _g : 20,
                    volumeType: (_h = args.nodeRootVolumeType) !== null && _h !== void 0 ? _h : "gp2",
                    iops: args.nodeRootVolumeIops,
                    throughput: args.nodeRootVolumeThroughput,
                    deleteOnTermination: ((_j = args.nodeRootVolumeDeleteOnTermination) !== null && _j !== void 0 ? _j : true) ? "true" : "false",
                },
            }],
        networkInterfaces: [{
    ...
    const asGroup = new aws.autoscaling.Group(name, {
        name: name,
        minSize: (_k = args === null || args === void 0 ? void 0 : args.minSize) !== null && _k !== void 0 ? _k : 1,
        maxSize: (_l = args === null || args === void 0 ? void 0 : args.maxSize) !== null && _l !== void 0 ? _l : 2,
        desiredCapacity: (_m = args === null || args === void 0 ? void 0 : args.desiredCapacity) !== null && _m !== void 0 ? _m : 2,
        launchTemplate: {
        ...
        instanceRefresh: {
            strategy: "Rolling",
            preferences: {
                minHealthyPercentage: (_o = args.minRefreshPercentage) !== null && _o !== void 0 ? _o : 50,
            },
        },
        tags: asgTags,
