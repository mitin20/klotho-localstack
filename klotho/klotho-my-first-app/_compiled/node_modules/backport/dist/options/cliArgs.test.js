...
describe('getOptionsFromCliArgs', () => {
    ...
    describe('multipleBranches', () => {
        ...
        it('should conflict when using both', () => {
            ...
            expect(() => (0, cliArgs_1.getOptionsFromCliArgs)(argv)).toThrowError('Arguments multiple and multipleBranches are mutually exclusive');
        });
    });
    describe('fork', () => {
        it('--fork', () => {
    ...
    describe('mainline', () => {
        ...
        it('should throw on invalid values', () => {
            ...
            expect(() => (0, cliArgs_1.getOptionsFromCliArgs)(argv)).toThrowError('--mainline must be an integer. Received: NaN');
        });
    });
    ...
    describe('repo', () => {
        ...
        it('throw if both --repo and --repo-name is given', () => {
            ...
            expect(() => (0, cliArgs_1.getOptionsFromCliArgs)(argv)).toThrowError('Arguments repo and repoName are mutually exclusive');
        });
    });
